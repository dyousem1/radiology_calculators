...
This repository provides free, web-based tools for benchmarking academic productivity in radiology. All data is sourced from Scopus and includes publication counts, citation metrics, and H-indices for over 7,200 faculty across 154 academic institutions.
...
| Body Imaging Combined | 2,037 | 103 | [Open Calculator](https://dyousem1.github.io/radiology_calculators/Body_Imaging_Combined_Percentile_Calculator.html) |
