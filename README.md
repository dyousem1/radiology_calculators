...
### 🏆 Top 25 Institutions by Subspecialty (NEW)

View the top 25 ranked institutions for each subspecialty across all metrics. Mayo Clinic separated by campus (Rochester, Jacksonville, Phoenix).
...
Institution names harmonized to 122 academic medical centers per Supplementary Table 1 (120 institutions with Mayo Clinic separated into 3 campuses: Rochester, Jacksonville, Phoenix).
...
- **Institution Harmonization:** All data standardized to 122 official academic medical centers per Supplementary Table 1
- **Top 25 Institutions Tool:** New tool showing top 25 ranked institutions by subspecialty
- **Institution Rankings Lookup:** Updated with harmonized 122 institutions
...
5. **Institution Rankings:** Compare institutions across subspecialties
6. **Top 25 Institutions:** View rankings by subspecialty
