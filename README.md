...
|--------------|---------|--------------|--------|
| 🫁 Abdominal Imaging | 1,452 | 103 | ✅ Live |
| 📊 All Radiologists | 7,678 | 160 | ✅ Live |
| 🫀 Body Imaging Combined | 2,031 | 104 | ✅ Live |
| 🎗️ Breast Imaging | 976 | 109 | ✅ Live |
| ❤️ Cardiothoracic Imaging | 585 | 86 | ✅ Live |
| 🚨 Emergency Radiology | 518 | 68 | ✅ Live |
| 🩺 Interventional Radiology | 907 | 103 | ✅ Live |
| 🦴 MSK Radiology | 678 | 95 | ✅ Live |
| 🔬 Neurointerventional Radiology | 404 | 122 | ✅ Live |
| 🧠 Neuroradiology | 1,057 | 113 | ✅ Live |
| ☢️ Nuclear Medicine | 522 | 108 | ✅ Live |
| 👶 Pediatric Radiology | 998 | 104 | ✅ Live |

**Total: 8,097 Faculty across 160 Institutions** (7,678 unique individuals in the deduplicated All Radiologists calculator)
...
- 160 institutions aggregated from 10 subspecialties
- 8,097 total faculty
...
Institution names harmonized to 160 institutions (Mayo Clinic separated into 3 campuses: Rochester, Jacksonville, Phoenix).

---

## Recent Updates (February 2026)

- **All Radiologists Calculator Added:** Cross-subspecialty calculator with 7,678 unique faculty from 160 institutions (deduplicated), filterable by any of 10 subspecialties
- **NIH Funding Added:** Both Institution Rankings Lookup and Top 25 Institutions now include NIH Radiology Funding (BRIMR 2025) data for 66 funded departments
- **Emergency Radiology Calculator Added:** New subspecialty with 518 faculty from 68 institutions
- **Overall Rankings Added:** Both Institution Rankings Lookup and Top 25 Institutions now include Overall view aggregating all subspecialties
- **Neurointerventional Radiology Calculator:** New subspecialty added with 404 faculty from 122 institutions
- **Pediatric Radiology Updated:** Now includes 998 faculty from 104 institutions
- **Mayo Clinic Campus Separation:** All tools now show Mayo Clinic Rochester, Jacksonville, and Phoenix as separate institutions
- **Institution Harmonization:** All data standardized to 160 institutions
- **Top 25 Institutions Tool:** Rankings by subspecialty with Overall and NIH Funding views
- **Institution Rankings Lookup:** Updated with 160 institutions, 12 subspecialties, 5 metrics + NIH Funding
