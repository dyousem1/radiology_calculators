...
|--------------|---------|--------------|--------|
| 🧠 Neuroradiology | 903 | 100 | ✅ Live |
| 🔬 Neurointerventional Radiology | 333 | 128 | ✅ Live |
| 🦴 MSK Radiology | 673 | 93 | ✅ Live |
| 🎗️ Breast Imaging | 969 | 107 | ✅ Live |
| ☢️ Nuclear Medicine | 514 | 102 | ✅ Live |
| 👶 Pediatric Radiology | 975 | 97 | ✅ Live |
...
| 🚨 Emergency Radiology | 518 | 72 | ✅ Live |

**Total: 7,800 Faculty across 127 Academic Medical Centers**
...
**NEW:** Includes **Overall** view showing aggregated metrics across all subspecialties for each institution.

### 🏆 Top 25 Institutions by Subspecialty

View the top 25 ranked institutions for each subspecialty across all metrics. 

**NEW:** Includes **Overall** tab showing combined rankings across all subspecialties:
- 127 institutions aggregated from 9 subspecialties
- 7,239 total faculty | 327,183 total papers
...
Institution names harmonized to 127 academic medical centers (Mayo Clinic separated into 3 campuses: Rochester, Jacksonville, Phoenix).

---

## Recent Updates (January 2025)

- **Emergency Radiology Calculator Added:** New subspecialty with 518 faculty from 72 institutions
...
- **Neurointerventional Radiology Calculator:** New subspecialty added with 333 faculty from 128 institutions
- **Pediatric Radiology Updated:** Now includes 975 faculty from 97 institutions
- **Mayo Clinic Campus Separation:** All tools now show Mayo Clinic Rochester, Jacksonville, and Phoenix as separate institutions
- **Institution Harmonization:** All data standardized to 127 official academic medical centers
- **Top 25 Institutions Tool:** New tool showing top 25 ranked institutions by subspecialty
- **Institution Rankings Lookup:** Updated with harmonized institutions and Overall view
...
© 2025 Johns Hopkins University School of Medicine
